 ...
 * Parameter 参数
 *
 * 用于 Dubbo {@link com.alibaba.dubbo.common.URL} 的参数拼接(使用了注解的属性，需要进行url拼接)
 */
@Documented
...
public @interface Parameter {
     ...
     * 是否为属性
     *
     * 目前用于《事件通知》http://dubbo.apache.org/books/dubbo-user-book/demos/events-notify.html
     * methodConfig里的和事件通知相关的onreturn等进行了使用
     */
